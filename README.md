...
We use a workflow file to run some tests on the code. A merge will not happen if the tests fail.  
We use Jest for unit tests, Newman for REST API tests, and WebdriverIO from BDD tests.
