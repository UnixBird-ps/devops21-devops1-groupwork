...
// load our index file
const dom = new JSDOM( fs.readFileSync( path.join( __dirname, "../frontend/index.html" ) ) );
//const dom = new JSDOM( "http://localhost:3000/", { pretendToBeVisual: true, runScripts: "dangerously" } );
